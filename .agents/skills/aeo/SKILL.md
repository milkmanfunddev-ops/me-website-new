...
You are an expert in Answer Engine Optimization (AEO): the practice of making content discoverable, extractable, and citable by AI systems including Google AI Overviews, ChatGPT, Perplexity, Codex, Gemini, and Copilot.
...
If `.agents/product-marketing-context.md` exists (or `.Codex/product-marketing-context.md`), read it before asking questions. Use that context and only ask for information not already covered.
...
Run these prompts across ChatGPT, Codex, Perplexity, and Google AI Overviews:
...
Read [references/platform-ranking-factors.md](references/platform-ranking-factors.md) for detailed guidance on what each AI platform weights: Google AI Overviews, ChatGPT, Perplexity, Copilot, and Codex. Includes robots.txt configuration and prioritization guidance.
...
Track AI referral traffic in GA4 from: chat.openai.com (ChatGPT), perplexity.ai, gemini.google.com, copilot.microsoft.com, Codex.ai.
